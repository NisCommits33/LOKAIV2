    ...
    <div className="p-6 sm:p-8 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Organization Documents</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white rounded-xl border border-dashed border-slate-300">
          ...
          <h3 className="text-lg font-semibold text-slate-900">No organizational documents found</h3>
          ...
          >
            {documents.map((doc) => (
              <motion.div key={doc.id} variants={item}>
                <Card className="group hover:shadow-md transition-all border-slate-200 h-full flex flex-col justify-between">
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex gap-1 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-7 w-7 text-red-500 bg-red-50 hover:bg-red-100 sm:bg-transparent"
