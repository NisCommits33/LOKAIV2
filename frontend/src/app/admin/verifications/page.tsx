  ...
  return (
    <div className="p-6 sm:p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 dark:bg-amber-950/30 border border-amber-100 dark:border-amber-800">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <Input
            ...
            className="pl-10 h-11 rounded-xl border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50 text-sm shadow-none"
          />
        </div>
      </div>
      ...
      {!isLoading && filtered.length === 0 && (
        <Card className="shadow-none border border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-900">
          <CardContent className="flex flex-col items-center justify-center py-20">
            <div className="h-16 w-16 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 flex items-center justify-center mb-6">
      ...
      {!isLoading && filtered.length > 0 && (
        <div className="space-y-3">
          {filtered.map((user) => (
            <Card
              key={user.id}
              className="shadow-none border border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-900 hover:border-slate-200 dark:hover:border-slate-600 transition-colors"
            >
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                  ...
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge
                          variant="outline"
                          className="shrink-0 text-[10px] font-black uppercase tracking-widest bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-400 border-amber-100 dark:border-amber-800"
                        >
                          Pending
                        </Badge>
                      </div>
                  ...
                  <div className="flex items-center gap-2 shrink-0 sm:ml-auto">
                    ...
                    <Button
                      ...
                      size="sm"
                      variant="outline"
                      className="h-9 border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 hover:text-red-700 rounded-lg text-xs font-bold shadow-none"
                    >
      ...
      >
        <DialogContent className="sm:max-w-md">
          ...
          {approveTarget && (
            <div className="rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 p-4 space-y-2">
              <div className="flex items-center gap-2 text-sm">
                <Mail className="h-4 w-4 text-slate-400" />
                <span className="text-slate-600 dark:text-slate-400">{approveTarget.email}</span>
              </div>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className="rounded-xl border-slate-100 dark:border-slate-700 h-11 shadow-none">
            ...
            {selectedReason === "Other" && (
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="rounded-xl border-slate-100 dark:border-slate-700 min-h-[100px] shadow-none resize-none"
                />
              </div>
            )}
          </div>
