          ...
          >
            <Card className="shadow-none border border-slate-100 overflow-hidden bg-white">
              <CardHeader className="text-center pt-12 px-10 bg-slate-50/50 border-b border-slate-100">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-red-50 border border-red-100 mb-6">
              ...
              <CardContent className="p-10 space-y-6">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="w-full h-12 rounded-xl border-slate-100 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-900 transition-all"
                  >
    ...
    <div className="py-12 bg-white flex-1 min-h-screen">
      <Container>
        ...
        >
          <Card className="shadow-none border border-slate-100 overflow-hidden bg-white">
            <CardHeader className="text-center pt-12 px-10 bg-slate-50/50 border-b border-slate-100">
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-amber-50 border border-amber-100 mb-6">
